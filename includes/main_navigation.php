<!-- MAIN NAVIGATION -->
			...
			<ul id="main-navigation">
				<li><a href="index.php"<?php if($page == 'home'){ echo(" class=\"active\"");} ?>>about</a></li><li><a href="index.php?do=create"<?php if($page == 'create'){ echo(" class=\"active\"");} ?>>add</a></li><li class="last"><a href="index.php?do=explore"<?php if($page == 'view'||$page == 'explore'){ echo(" class=\"active\"");} ?>>explore</a></li></ul>
